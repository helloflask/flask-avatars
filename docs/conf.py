...
html_theme_options = {
    # 'github_user': 'greyli',
    'index_logo': 'logo.png',
    'github_fork': 'greyli/flask-avatars',
...
htmlhelp_basename = 'Flask-Avatarsdoc'
...
latex_documents = [
    (master_doc, 'Flask-Avatars.tex', u'Flask-Avatars Documentation',
     u'Grey Li', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'Flask-Avatars', u'Flask-Avatars Documentation',
     author, 'Flask-Avatars', 'One line description of project.',
     'Miscellaneous'),
]
